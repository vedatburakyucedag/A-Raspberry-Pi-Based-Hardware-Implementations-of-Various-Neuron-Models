...
for i in range(0, 3):
    ...
    x = x + (hh / 6) * (dx1 + 2 * dx2 + 2 * dx3 + dx4); x1.append(x)
    y = y + (hh / 6) * (dy1 + 2 * dy2 + 2 * dy3 + dy4); y1.append(y)
    z = z + (hh / 6) * (dz1 + 2 * dz2 + 2 * dz3 + dz4); z1.append(z)
...
while 1:
    ...
    x = x1[3] + hh / 24 * (55 * fx3 - 59 * fx2 + 37 * fx1 - 9 * fx0)
    y = y1[3] + hh / 24 * (55 * fy3 - 59 * fy2 + 37 * fy1 - 9 * fy0)
    z = z1[3] + hh / 24 * (55 * fz3 - 59 * fz2 + 37 * fz1 - 9 * fz0)

    x1.pop(0); x1.insert(3, x); #print(x1)
    y1.pop(0); y1.insert(3, y)
    z1.pop(0); z1.insert(3, z)
