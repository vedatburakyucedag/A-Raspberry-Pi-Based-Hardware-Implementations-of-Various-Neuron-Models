function [V,h,m,n] = function_hh_am_1n(I,C,E_Na,E_K,E_Leak,g_Na,g_K,g_Leak,t,V,h,m,n,hh,N,a,f,Vrest)
...
fn=@(t,V,n)     (0.01*(10-(V+Vrest)))/(exp((10-(V+Vrest))/10)-1) * (1 - n) - 0.125*exp(-(V+Vrest)/80) * n;
    ...
    for i=3:N
        ...
        V(i+1) = V(i) + hh/24 * (9*fV(t(i+1),V(i+1),h(i+1),m(i+1),n(i+1)) + 19*fV(t(i),V(i),h(i),m(i),n(i)) - 5*fV(t(i-1),V(i-1),h(i-1),m(i-1),n(i-1)) + fV(t(i-2),V(i-2),h(i-2),m(i-2),n(i-2)));
        h(i+1) = h(i) + hh/24 * (9*fh(t(i+1),V(i+1),h(i+1)) + 19*fh(t(i),V(i),h(i)) - 5*fh(t(i-1),V(i-1),h(i-1)) + fh(t(i-2),V(i-2),h(i-2)));
        m(i+1) = m(i) + hh/24 * (9*fm(t(i+1),V(i+1),m(i+1)) + 19*fm(t(i),V(i),m(i)) - 5*fm(t(i-1),V(i-1),m(i-1)) + fm(t(i-2),V(i-2),m(i-2)));
        n(i+1) = n(i) + hh/24 * (9*fn(t(i+1),V(i+1),n(i+1)) + 19*fn(t(i),V(i),n(i)) - 5*fn(t(i-1),V(i-1),n(i-1)) + fn(t(i-2),V(i-2),n(i-2)));
