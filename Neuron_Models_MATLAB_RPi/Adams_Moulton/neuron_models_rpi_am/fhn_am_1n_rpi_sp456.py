...
#v = 1.6418;  w = -0.4184; a=0.7; b=0.8; c=5; aa=0.5; f=0.110; I=0; t=0; # 1 adet ch
#v = -1.6527; w = -0.0476; a=0.7; b=0.8; c=5; aa=0.5; f=0.130; I=0; t=0; # 2 adet ch
v = -0.6135; w = -0.5666; a=0.7; b=0.8; c=5; aa=0.5; f=0.129; I=0; t=0; # 3 adet ch
...
for i in range(0, 3):
    t=t+h;
    dv1 = c * (v - w + I - ((math.pow(v, 3)) / 3)) + (aa/(2*math.pi*f))*math.cos(2*math.pi*f*t)
    dw1 = (v - b * w + a) / c

    fxv2 = v + (h / 2) * dv1
    fxw2 = w + (h / 2) * dw1
    dv2 = c * (fxv2 - fxw2 + I - ((math.pow(fxv2, 3)) / 3)) + (aa/(2*math.pi*f))*math.cos(2*math.pi*f*t)
    dw2 = (fxv2 - b * fxw2 + a) / c

    fxv3 = v + (h / 2) * dv2
    fxw3 = w + (h / 2) * dw2
    dv3 = c * (fxv3 - fxw3 + I - ((math.pow(fxv3, 3)) / 3)) + (aa/(2*math.pi*f))*math.cos(2*math.pi*f*t)
    dw3 = (fxv3 - b * fxw3 + a) / c

    fxv4 = v + h * dv3
    fxw4 = w + h * dw3
    dv4 = c * (fxv4 - fxw4 + I - ((math.pow(fxv4, 3)) / 3)) + (aa/(2*math.pi*f))*math.cos(2*math.pi*f*t)
    dw4 = (fxv4 - b * fxw4 + a) / c
