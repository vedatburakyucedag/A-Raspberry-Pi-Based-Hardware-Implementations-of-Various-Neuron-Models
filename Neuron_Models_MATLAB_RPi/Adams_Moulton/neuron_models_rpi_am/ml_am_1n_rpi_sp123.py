...
while 1:
    ...
    dV1 = (I - ((g_Ca * 0.5 * (1 + math.tanh((V - V1) / V2)) * (V - E_Ca)) + (g_K * W * (V - E_K)) + (
                g_Leak * (V - E_Leak)))) / C
    dW1 = (0.5 * (1 + math.tanh((V - V3) / V4)) - W) / ((T0) / (math.cosh((V - V3) / (2 * V4))))

    fxV2 = V + (h / 2) * dV1
    fxW2 = W + (h / 2) * dW1
    dV2 = (I - ((g_Ca * 0.5 * (1 + math.tanh((fxV2 - V1) / V2)) * (fxV2 - E_Ca)) + (g_K * fxW2 * (fxV2 - E_K)) + (
                g_Leak * (fxV2 - E_Leak)))) / C
    dW2 = (0.5 * (1 + math.tanh((fxV2 - V3) / V4)) - fxW2) / ((T0) / (math.cosh((fxV2 - V3) / (2 * V4))))

    fxV3 = V + (h / 2) * dV2
    fxW3 = W + (h / 2) * dW2
    dV3 = (I - ((g_Ca * 0.5 * (1 + math.tanh((fxV3 - V1) / V2)) * (fxV3 - E_Ca)) + (g_K * fxW3 * (fxV3 - E_K)) + (
                g_Leak * (fxV3 - E_Leak)))) / C
    dW3 = (0.5 * (1 + math.tanh((fxV3 - V3) / V4)) - fxW3) / ((T0) / (math.cosh((fxV3 - V3) / (2 * V4))))

    fxV4 = V + h * dV3
    fxW4 = W + h * dW3
    dV4 = (I - ((g_Ca * 0.5 * (1 + math.tanh((fxV4 - V1) / V2)) * (fxV4 - E_Ca)) + (g_K * fxW4 * (fxV4 - E_K)) + (
                g_Leak * (fxV4 - E_Leak)))) / C
    dW4 = (0.5 * (1 + math.tanh((fxV4 - V3) / V4)) - fxW4) / ((T0) / (math.cosh((fxV4 - V3) / (2 * V4))))
