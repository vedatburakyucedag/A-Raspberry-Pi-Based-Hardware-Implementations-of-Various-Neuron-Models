function [vv, ww] = function_fhn_abm_1n(a,b,c,I,h,N,t,v,w,aa,f)
...
fw=@(t,v,w)  (v - b*w + a)/c;
    ...
    for i=4:N
        ...
        vv(i+1) = v(i) + h/24 * (9*fv(t(i+1),v(i+1),w(i+1)) + 19*fv(t(i),v(i),w(i)) - 5*fv(t(i-1),v(i-1),w(i-1)) + fv(t(i-2),v(i-2),w(i-2)));
        ww(i+1) = w(i) + h/24 * (9*fw(t(i+1),v(i+1),w(i+1)) + 19*fw(t(i),v(i),w(i)) - 5*fw(t(i-1),v(i-1),w(i-1)) + fw(t(i-2),v(i-2),w(i-2)));
