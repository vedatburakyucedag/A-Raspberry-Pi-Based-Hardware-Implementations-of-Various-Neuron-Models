...
[v_fs,u_fs] = function_iz_abm_1n(a_fs,b_fs,c_fs,I,d_fs,t,v_fs,u_fs,h,N);
[v_rz,u_rz] = function_iz_abm_1n(a_rz,b_rz,c_rz,I,d_rz,t,v_rz,u_rz,h,N);
[v_tc,u_tc] = function_iz_abm_1n(a_tc,b_tc,c_tc,I,d_tc,t,v_tc,u_tc,h,N);
[v_rs,u_rs] = function_iz_abm_1n(a_rs,b_rs,c_rs,I,d_rs,t,v_rs,u_rs,h,N);
[v_lt,u_lt] = function_iz_abm_1n(a_lt,b_lt,c_lt,I,d_lt,t,v_lt,u_lt,h,N);
[v_br,u_br] = function_iz_abm_1n(a_br,b_br,c_br,I_br,d_br,t,v_br,u_br,h,N);

save mat_iz_abm_sp123456.mat v_fs v_rz v_tc v_rs v_lt v_br
